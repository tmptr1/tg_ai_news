...
if __name__ == '__main__':
    ...
    # ai_req_text = f'Проанализируй пост, проверь ссылку на источник и определи: это новость текущего дня или нет? Отвёт помести в переменную res = "да" или res = "нет". Вот текст поста: \n{tg_post}'
    # ai_req_text = f'Проанализируй пост, проверь ссылку на источник и определи: это новость была опубликована 13 февраля 2026 года или нет? Отвёт помести в переменную res = "да" или res = "нет". Вот текст поста: \n{tg_post}'
